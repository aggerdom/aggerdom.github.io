...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        (
            (
                ("/psychology-links.html", "Psychology Links"),
                ("/cognitive-science-links.html", "Cognitive Science Links"),
                ("/philosophy-links.html", "Philosophy Links"),
                ("/neuroscience-links.html", "Neuroscience Links"),
                ("/data-science-links.html", "Data Science Links"),
                ("/programming-links.html", "Programming Links"),
                ("/logic-links.html", "Logic Links"),
                ("/math-links.html", "Math Links"),
                ("/misc-links.html", "Misc Links"),
                ("/russian-links.html", "Russian Links"),
                ("/unsorted_links.html", "Unsorted Links" ),
                ("/math-links.html", "Math Links"),
            ),
            "Lists-O-Links"
        ),
